...
layout: country
ref: egypt
permalink: /en/redsea/egypt/

lang: en
lang-flag: 🇬🇧

title: Diving in Egypt
description: Sam & Tof - Scuba diving in Egypt

sea: redsea
menu: Egypt
visited-in: November 2021 and September 2022
h1: 🇪🇬 Egypt
...
dive-shop: |
  ...
  **Oasis Diving Resort <i class="fa fa-heart"></i>**  offers dive packages, you pick the next day's dive plan the evening before. Watch out though, everything comes at a cost in Egypt, the best dives are extras, whether that's beach access at a resort (even a closed one), entry to the marine parks, or a boat/zodiac surcharge.

  It's possible to dive from the reef house, but we didn't have time to do that.

  The dive staff, guides, and the team running the compressor and gear are extremely efficient and really friendly. All the guides are instructors, and maybe a bit too "by the book" and overprotective, but they're genuinely committed to making sure every level has a good time. Groups are arranged by level, 60 minutes max, briefings are very clear, and independent diving is possible.

  In September 2022.
  {: .visited-in}

  **[Diving Attitude](https://divingattitude.com/){: target="_blank"}** currently has two boats and offers several cruises. The Exocet is a beautiful, recent boat with a capacity of 25 people and very large cabins. They favor independent divers. Nitrox is included, with a maximum of 3 dives a day. The atmosphere is good, though we were sorry to be diving all together on the same sites every time. The Exocet remains one of the best cruise boats we've been on in terms of comfort, cleanliness and food.
...
to-see: |
  ...
  Egypt is packed with magnificent sites around the Nile Valley, you'd need a dedicated trip to see it all. It's possible to get around on your own for the visits, but a guide and driver are strongly recommended to make the most of it.
...
- author: Sam
  ...
  date: 29/11/2021
  text: |
    An early start to make the most of being first in the water, since Abu Dabbab bay is very popular with divers and snorkelers alike. We spend 60 minutes exploring the bay's large seagrass bed, after 5 minutes, an array of giant green turtles with decent-sized remoras on their backs, stingrays, spotted eagle rays, bluespotted stingrays, mackerel, a sleeping squid. So much richness, it's a bit like the local Galápagos, we don't know where to look. A magnificent dive with gorgeous light and very good visibility.
- author: Sam
  place: Elphinstone
  date: 30/11/2021
  text: |
