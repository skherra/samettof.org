...
layout: country
ref: iceland
permalink: /en/atlantic/iceland/

lang: en
lang-flag: 🇬🇧

title: Diving in Iceland
description: Sam & Tof - Scuba diving in Iceland
...
dive-shop: |
  ...
  The dive masters come from all over the world and are very friendly. The service is worthy of a 5-star hotel (even if changing at the back of the truck in a parking lot can be tough in freezing weather).

accommodation: |
  In March 2019.
  {: .visited-in}

  There are various types of accommodation in Reykjavik, downtown is small, so just plan for an apartment rental, a guest house or a hotel reasonably close to a bus stop for excursions.

  We enjoyed staying in **Hreidar**'s small, very functional apartment.
...
- author: Tof
  ...
  date: 14/03/2019
  text: |
    Crossing the snow-covered Suðurland region offers grand landscapes. We arrive at Þingvallavatn lake under a wide blue sky and a beautiful low sun. We set up the tanks at the entrance of the fissure, then go park the van at the exit point to change. We then reach our entry point after a short 10-minute walk in the snow along the lake. The jump from the shore, nearly 2 meters above the 2 °C water, is breathtaking.

    We begin our exploration with the two forks at the end of the fissure. The water is crystal clear and the colors a deep blue, though the sun is starting to haze over. We then turn back to follow the long canyons of the fissure through the black volcanic rock debris. The surface offers a mirror barely disturbed by a few ripples.

    We come across a small group of good-sized Salmo trutta, whose peace and quiet we disturb.

    After a good half hour of exploring, we turn left above the edge of the fissure to find ourselves in the lake. The roughly ten-minute return to shore along a guide line, through rather murky water, isn't particularly interesting.
- author: Sam
  place: Silfra
  date: 13/03/2019
  text: |
