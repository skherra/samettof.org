...
layout: country
ref: palau
permalink: /en/pacific/palau/

lang: en
lang-flag: 🇬🇧

title: Diving in Palau
description: Sam & Tof - Scuba diving in Palau
...
dive-shop: |
  ...
  **[Sam's Tours](https://www.samstours.com/){: target="_blank"}** is a very large club with a fleet of 6 big, fast boats. PADI system, 10 divers with 2 dive masters, dives are no-deco and last around sixty minutes, preferably on nitrox.
  ...
  Despite that somewhat rigid side, the dive masters, Jeremy, Eve and Matt in particular, are excellent and passionate.
...
to-see: |
  ...
  The **[Jellyfish Lake](https://en.wikipedia.org/wiki/Jellyfish_Lake){: target="_blank"}** is one of Palau's star attractions, one of the 5 jellyfish lakes is open to the public (reopened 2 years ago). The experience of swimming among these jellyfish, which have lost their ability to sting, is pretty magical.

  A Cessna tour with **[Smile Air](https://smile-air.com){: target="_blank"}** to see the beauty of Palau's islands from above, a really beautiful experience.
...
- author: Sam
  ...
  date: 07/02/2020
  text: |
    A descent onto the small corner, a festival of about twenty gray reef sharks, snapper. We hold on at 14 meters and enjoy the show for a good 35 minutes. Then we make our way through the equally beautiful coral garden. We see a group of 10 bumphead parrotfish, further on several Napoleon wrasse. A superb dive, we're only 8 divers in the water, which is rare enough to be worth mentioning.
- author: Sam
  place: Peleliu Wall
  date: 16/02/2020
  text: |
    Peleliu island is an hour by speedboat from Koror, the sea is calm and the sun is out. We try Peleliu Corner, but a strong swell forces us to switch to Peleliu Wall. We're not disappointed, it's a festival of gray reef sharks, small nurse sharks, turtles, bumphead parrotfish, Napoleon wrasse, schools of snapper and jacks. A beautiful drift dive of more than an hour with really good visibility, the wall is impressive. We reach a small corner where we see about twenty sharks moving against the current, a really beautiful finish.
---
