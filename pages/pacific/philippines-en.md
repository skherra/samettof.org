...
layout: country
ref: philippines
permalink: /en/pacific/philippines/

lang: en
lang-flag: 🇬🇧

title: Diving in the Philippines
description: Sam & Tof - Scuba diving in the Philippines

sea: pacific
menu: Philippines
visited-in: May 2023 and February 2026
h1: 🇵🇭 Philippines

country-desc: |
  The **[Philippines](https://en.wikipedia.org/wiki/Philippines){: target="_blank"}** are an archipelago of more than 5&nbsp;000 islands and islets between the Sulu Sea, the South China Sea, the Celebes Sea and the Philippine Sea, bordered by the Pacific Ocean. It takes several trips to discover this vast country, where each destination has to be earned, since some spots are hard to reach and land transfers take time.
...
- title: Coron
  text: |
    In Coron, the dives are mostly wreck dives on Japanese ships sunk in 1944 by the American army. The wrecks are varied, at different depths, from 18 to 31 meters, and all interesting to explore, inside and out.

    We didn't get great visibility, nor much big stuff, but the wrecks are covered in soft and hard coral and small critters, great for macro lovers. The reefs are true coral gardens and hold their own after deep dives. We didn't have much current, and entries are made easier by buoys attached to the wrecks.

    Reachable by ferry, you'll need to arrange transfers to get around.
- title: Tubbataha
  text: |
...
- title: Malapascua
  text: |
    **[Malapascua](https://en.wikipedia.org/wiki/Malapascua_Island){: target="_blank"}** is a small island north of Cebu. People mainly come here for the thresher sharks at Kimud Shoal. The other sites, like the Dakit pinnacle, are also worth seeing for the macro. There are a lot of divers at the sites, but the dive masters generally enforce the rules well, and courtesy is the norm.
    ...
    The weather is very changeable, and shark trips are sometimes cancelled by the coast guard, since the sites are an hour by boat away. So it's worth planning extra time on the island to make sure you get a thresher shark trip in. The sites around the island are good for small stuff but less rich overall.

    Reachable by private outrigger boats or "ferry" outriggers, a 45-minute to 1-hour ride.

dive-shop: |
  In February 2026.
  {: .visited-in}

  **[Magic Island <i class="fa fa-heart"></i>](https://magicisland.online/){: target="_blank"}** offers all-inclusive packages with 3 dives a day, a night dive on request, and the reef house available. The guides have a good eye for spotting small stuff, and the dives are really laid-back. The outriggers are fairly basic, we go out in small groups for 2 dives in the morning, with fruit and coffee waiting for us at the surface interval. The sites are less than 15 minutes away. The club runs a whale shark dive trip (10 m max) at Oslob.

  **[Thresher Shark Divers](https://malapascua-diving.com/){: target="_blank"}**, a very large, impersonal dive club. Groups are made up of 5 divers max, put together somewhat randomly, the various dive masters rotate ascents so everyone gets to make the most of the time underwater. There are several site options each day, and you have to sign up the evening before, everything is extra (marine park, dive site, fuel). The 3 large outriggers are fairly comfortable and have toilets, and they have two small rigid boats for dives around the island. It's a shame there are no snacks at the surface interval.
...
accommodation: |
  ...
  **[Magic Island](https://magicisland.online/){: target="_blank"}** on Cebu island, in the Moalboal area, is a beautiful dive resort set away from town, quiet and clean, small capacity, with mostly German-speaking guests. The menu is varied, with lots of fish and vegetarian dishes, and the food is tasty. The resort offers excursions as well as quality massages.

  **[Tepanee Beach Resort](https://www.tepanee.com/){: target="_blank"}** a bit removed from town with a beautiful view over the bay. The bungalows are nice, the welcome is a bit rough around the edges, and it can be hard to communicate. The hotel might still be the quietest spot in town, aside from hearing boat engines from 5am onward.

  **[Summit Galleria in Cebu City](https://summithotels.ph/hotels/summit-galleria-cebu?utm_source=GBP&utm_medium=organic&utm_campaign=gbp-cebu){: target="_blank"}**
  ...
  **[Belmont Hotel](https://belmonthotelmanila.com){: target="_blank"}** makes for a good transit stop in Manila. Small rooftop and pool bar on the top floor. The advantage is being able to walk from the airport to the hotel in under 10 minutes.

to-see: |
  In May 2023.
  {: .visited-in}

  Our itinerary in Palawan deserved a stop at **[El Nido](https://en.wikipedia.org/wiki/El_Nido,_Palawan){: target="_blank"}**, although much more touristy than Coron, the scenery and tours A, B, C or D (island hopping) are all stunning. We chose tours A and B, B is relaxed and takes you to quiet, paradise-like islands. A short tour of the town is also worth it, between the tuktuks and the joyful bustle everywhere.
