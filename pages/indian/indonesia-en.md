...
layout: country
ref: indonesia
permalink: /en/indian/indonesia/

lang: en
lang-flag: 🇬🇧

title: Diving in Indonesia
description: Sam & Tof - Scuba diving in Indonesia

sea: indian
menu: Indonesia
visited-in: September 2017 and January 2025
h1: 🇮🇩 Indonesia

country-desc: |
  The **[Indonesian](https://en.wikipedia.org/wiki/Indonesia){: target="_blank"}** archipelago is the largest in the world and part of the great **[Coral Triangle](https://en.wikipedia.org/wiki/Coral_Triangle){: target="_blank"}** spanning the Indian and Pacific Oceans, along with the Philippines and Malaysia in particular. The marine life is incredibly rich.

  Komodo and **[Raja Ampat](https://en.wikipedia.org/wiki/Raja_Ampat_Islands){: target="_blank"}** are among the most famous archipelagos in the world, and their reputation is well deserved.
...
- title: Komodo
  text: |
    Formed of volcanic islands, Komodo's dive sites are very rich in marine life, with highly varied topography. At Komodo, the current, sometimes strong, brings in abundant life.
...
- title: Raja Ampat
  text: |
    ...
    **Raja Ampat**, a few hours' sail from Sorong, offers fish-rich, teeming sites, the guest star remains the **[wobbegong](https://en.wikipedia.org/wiki/Wobbegong){: target="_blank"}**, or carpet shark. To the south you'll see mostly soft corals, to the north it's more about current and hard corals. There's small stuff and big stuff alike, but visibility isn't always on your side. We stayed in the Central Raja Ampat area to enjoy the well-known manta dive sites there, and we weren't disappointed.
- title: Nusa Penida
  text: |
    From Bali we took a speedboat to **Nusa Penida** from Sanur. Plan on about 35 minutes. On the beach, all the tourists wait to catch the boat. The dives are enjoyable, and if you're patient you might see mola molas and mantas.
...
dive-shop: |
  ...
  **[Nico Dives Cool](https://nicodivescoolbali.com/){: target="_blank"}**, a French-speaking club in Bali, very responsive by email. A relaxed, easygoing guide despite the bustle of boats at Nusa Penida.

accommodation: |
  In January 2025.
  {: .visited-in}

  **[Swiss Bellhotel](https://www.swiss-belhotel.com/en-gb/swiss-belhotel-sorong){: target="_blank"}**, in Sorong, a comfortable and welcoming hotel.
...
to-see: |
  ...
  The **[dragons](https://en.wikipedia.org/wiki/Komodo_dragon){: target="_blank"}** on Rinca island or Komodo island.

  Jump off a rope into the waterfall on the small island of **[Moyo](https://en.wikipedia.org/wiki/Moyo_Island){: target="_blank"}**.

  In Bali, admire the countless village temples, or the most prestigious ones like **[Besakih](https://en.wikipedia.org/wiki/Pura_Besakih){: target="_blank"}, [Goa Gajah](https://en.wikipedia.org/wiki/Goa_Gajah){: target="_blank"}, [Tirta Gangga](https://en.wikipedia.org/wiki/Tirta_Gangga){: target="_blank"}**.
