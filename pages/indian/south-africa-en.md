...
layout: country
ref: south-africa
permalink: /en/indian/south-africa/

lang: en
lang-flag: 🇬🇧

title: Diving in South Africa
description: Sam & Tof - Scuba diving in South Africa
...
accommodation: |
  ...
  The **[Scuba Addicts](https://www.scubaaddicts.com/scuba-diving-south-africa.html){: target="_blank"}** lodge is very spacious and comfortable. Every room looks out over the sea, there's a small pool, and the dive club is right inside the lodge.

to-see: |
  The **[Hluhluwe-Imfolozi](https://en.wikipedia.org/wiki/Hluhluwe%E2%80%93iMfolozi_Park){: target="_blank"}** park (the oldest game reserve in the world) for a chance to spot the Big Five. Tours are led by a park ranger, fascinating.

  Lake **[St Lucia](https://en.wikipedia.org/wiki/iSimangaliso_Wetland_Park){: target="_blank"}** to admire crocodiles, hippos and seabirds.
