...
layout: country
ref: spain
permalink: /en/mediterranean/spain/

lang: en
lang-flag: 🇬🇧

title: Diving in the Mediterranean in Spain
description: Sam & Tof - Scuba diving in the Mediterranean in Spain
...
country-desc: |
  Spain offers a great variety of dive sites, with its Mediterranean and Atlantic coastlines.

  We had discovered Estartit and the **[Medes Islands](https://en.wikipedia.org/wiki/Illes_Medes){: target="_blank"}**, the "Mecca" of Mediterranean diving, twenty years earlier. As very young divers, we were delighted to discover red coral, gorgonians, scorpionfish and large, fairly unfazed groupers. The sites are just as beautiful and rich twenty years later. For us, the Medes Islands are the richest sites in the Mediterranean for flora and fauna. The Medes Islands are a 10-minute boat ride from Estartit. You have to pay a marine tax for every dive, bookings are made in advance, and there's generally only one boat per dive site.
...
to-see: |
  ...
  - A 360-degree view from the top of the ramparts of **[Montgrí Castle](https://en.wikipedia.org/wiki/Montgr%C3%AD_Castle){: target="_blank"}**, after a short hike.
