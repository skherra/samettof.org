...
layout: country
ref: italy
permalink: /en/mediterranean/italy/

lang: en
lang-flag: 🇬🇧

title: Diving in the Mediterranean in Sardinia
description: Sam & Tof - Scuba diving in the Mediterranean in Sardinia

sea: mediterranean
menu: Italy
visited-in: September 2021, September 2025
h1: 🇮🇹 Italy
...
- title: Sardinia
  text: |
    ...
    Reachable by ferry or plane, you'll need a car to get around.
- title: Ustica
  text: |
    **[Ustica <i class="fa fa-heart"></i>](https://en.wikipedia.org/wiki/Ustica){: target="_blank"}** has been a marine reserve since 1986. It was the first in Italy. Still spared from mass tourism, despite the large ferry and the 8 dive clubs, the island is small and really pleasant. The activities are diving and hiking. There's a good twenty dive sites, the furthest of which are 15 minutes by boat from the harbor.

    We saw lots of big groupers, balls of small fish, and some nice hunting action along the walls. The caves and arches host small corals and crustaceans. The dives are really beautiful.

    The clubs leave at staggered times so that each boat is alone (or nearly so) underwater.

    Reachable by ferry from Palermo, the island is small, and everything can be done on foot, by electric bike, or by shuttle.
...
dive-shop: |
  ...
  **[Nautilus Diving](https://www.divesardegna.com/){: target="_blank"}** is a small club in Palau, close to the Maddalena and Lavezzi archipelagos (50 minutes away). This small team takes good care of divers before and after dives, underwater they're very attentive, though not very chatty, which we found a bit disappointing.

  They have two boats, a covered, mid-sized one, which is a nice bonus in this region, that can take 14 divers, and a rigid inflatable with a capacity of 8 divers. Groups are split by level. You go out for 2 dives back to back in the morning, with a roughly 60-minute limit. An afternoon dive is possible. Padi-style no-deco dives, Nitrox available for an extra fee.
...
accommodation: |
  ...
  The dive club offered us a choice of accommodation, we settled near the small Vecchio marina on the outskirts of Palau, a well-equipped, quiet house with a magical view over the islands.
...
to-see: |
  ...
  The village of Santa Teresa di Gallura.

  A bit further, **[Castelsardo](https://en.wikipedia.org/wiki/Castelsardo){: target="_blank"}**, a charming little medieval village.
