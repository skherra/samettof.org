...
layout: country
ref: antigua
permalink: /en/caribbean/antigua/

lang: en
lang-flag: 🇬🇧

title: Diving in Antigua
description: Sam & Tof - Scuba diving in Antigua
...
accommodation: |
  ...
  **[Energie](https://www.energieantigua.com/accommodation){: target="_blank"}** offers well-equipped, luxurious apartments in English Harbour, with a stunning view over the bay. A nice air-conditioned gym also adds to the appeal of the place.

to-see: |
  In May 2026.
  {: .visited-in}

  There are several archaeological sites to visit on the island, old forts and the sugar mills of **[Betty's Hope](https://sugarmills.blogs.bucknell.edu/bettys-hope/){: target="_blank"}**, Nelson's Dockyard and Fort Berkeley.

  Climb up **[Fort Barrington](https://en.wikipedia.org/wiki/Fort_Barrington,_Antigua_and_Barbuda){: target="_blank"}** to admire the view over the mangroves and the sea.

  Watch pelicans, egrets, frigatebirds and oystercatchers at **McKinnon's Salt Pond**, though the surroundings are unfortunately polluted with litter.

  There are several nice hikes around Falmouth for beautiful viewpoints, including the loop from Galleon Beach to Shirley Heights, **[the carpenter rock trail](https://www.antiguamarineguide.com/hikes/carpenter-rock-trail.){: target="_blank"}**, which offers magnificent views over the cliffs and Falmouth Harbour bay.

  The walk via Turtle Bay to **Rendez-vous beach** also offers beautiful views of the bay. Finally, the short walk to **Monk Hill** is worth it, with an almost 360-degree view.
