...
layout: country
ref: bonaire
permalink: /en/caribbean/bonaire/

lang: en
lang-flag: 🇬🇧

title: Diving in Bonaire
description: Sam & Tof - Scuba diving in Bonaire

sea: caribbean
menu: Bonaire
visited-in: March and December 2022
h1: 🇧🇶 Bonaire
...
country-desc: |
  **[Bonaire](https://en.wikipedia.org/wiki/Bonaire){: target="_blank"}** sits at the very south of the Caribbean, facing Venezuela, and together with Aruba and Curaçao forms the Dutch Leeward Antilles. Bonaire, like [Statia](/en/caribbean/statia/), is part of the Netherlands.
  ...
  Every dive is beautiful. Despite the crowds on the island, you're usually all alone underwater. You just need to pick your sites based on timing and the number of cars already there. Sites near the resorts get more traffic.
...
accommodation: |
  ...
  **[Tropical diver resort](https://www.tropicaldiversbonaire.com/){: target="_blank"}** next to the airport, well located to explore both north and south. There are rooms and apartments; the apartments are bigger, reasonably well equipped and spaced further apart. Air conditioning and mosquito screens in the room aren't a luxury. A few minutes' drive away, there's a big, well-stocked supermarket.
...
log-books:
- author: Sam
  place: Aquarius, Ostracod night dive
  date: 23/03/2022
  text: |
    We went in after nightfall, just after the full moon, with a guide who knows exactly where it happens. We cross without a light, which has a certain charm and lets our eyes adjust to the dark. Then the magic happens after a few sweeps of the light over the bottom at 6 meters. Tiny lights, like little rockets, start flickering to life. We spent more than twenty minutes watching these ostracods, the light they give off is used to distract predators, or simply to attract females for mating. Pure magic.
- author: Sam
  place: Tori reef
  date: 22/03/2022
  text: |
    Descent from the pier down a long tongue of sand, we follow the reef with lots of fixed marine life, the spot is teeming with fish. A large green moray hunts in open water above us. We have wonderful visibility and beautiful light, we come across a huge school of bonitos before ascending onto the equally magnificent plateau, shrimp, small moray eels and tropical fish.
---
